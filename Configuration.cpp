...
QString Configuration::lotw_pwd () const {return m_->lotw_pwd_;}      //avt 9/23/25
bool Configuration::nonQsl () const {return m_->nonQsl_;}      //avt 9/23/25
...
bool Configuration::autoLog() const {return !m_externalCtrlMode and m_->autoLog_;}    //avt 10/2/25
...
bool Configuration::Wait_features_enabled () const {return !m_externalCtrlMode and m_->Wait_features_enabled_;}    //avt 10/2/25
...
bool Configuration::clear_DXcall () const {return !m_externalCtrlMode and m_->clear_DXcall_;}   //avt 10/2/25
bool Configuration::highlight_DXgrid () const {return m_->highlight_DXgrid_;}
bool Configuration::clear_DXgrid () const {return !m_externalCtrlMode and m_->clear_DXgrid_;}   //avt 10/2/25
...
void Configuration::impl::initialize_models ()
{
  ...
  ui_->lotwEntry->setText (lotw_pwd_);      //avt 9/23/25
  ui_->nonqsl_check_box->setChecked(nonQsl_);      //avt 9/23/25
...
void Configuration::impl::accept ()
{
  ...
  lotw_pwd_ = ui_->lotwEntry->text ();      //avt 9/23/25
  nonQsl_ = ui_->nonqsl_check_box->isChecked ();      //avt 9/23/25
...
void Configuration::impl::on_CTY_download_button_clicked (bool /*clicked*/)
{
  ...
  cty_download.configure(network_manager_,
                         ...
                         "Decodium v3.0 FT2 Raptor 2603070001 CTY Downloader");
...
void Configuration::impl::on_decoded_text_font_push_button_clicked ()
{
  next_decoded_text_font_ = QFontDialog::getFont (0, decoded_text_font_ , this
                                                  , tr ("Decodium v3.0 FT2 Raptor 2603070001 Decoded Text Font Chooser")
